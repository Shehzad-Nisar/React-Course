...
const Menu = ({name= "place",price = 400000}) => {
    console.log("props:",name)
  return (
    <>
   <a href="#" className="block rounded-lg p-4 shadow-xs shadow-indigo-100">
  <img alt="" src="https://images.unsplash.com/photo-1613545325278-f24b0cae1224?auto=format&amp;fit=crop&amp;q=80&amp;w=1160" className="h-56 w-full rounded-md object-cover" />
    ...
    <div className="mt-6 flex items-center gap-8 text-xs">
      ...
      <div className="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
        ...
        <div className="mt-1.5 sm:mt-0">
          ...
          <p name="text-gray-500">Bedroom</p>
